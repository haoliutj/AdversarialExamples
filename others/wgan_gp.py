...
# img.shape[0]=channels (or batch_size), so input_shape=[H,W] instead of input_shape=[channels,H,W]
input_shape = (opt.input_hight, opt.input_wide)
...
torch.save(generator.state_dict(),'./model/g_wgan_gp.pth')
torch.save(discriminator.state_dict(),'./model/d_wgan_gp.pth')